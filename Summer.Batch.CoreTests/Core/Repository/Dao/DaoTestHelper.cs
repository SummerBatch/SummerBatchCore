...
namespace Summer.Batch.CoreTests.Core.Repository.Dao
{
    ...
    {
        static DaoTestHelper(){
            DbProviderFactories.RegisterFactory("System.Data.SqlClient", SqlClientFactory.Instance);
        }

        private const string ConnectionString = @"Data Source=(LocalDB)\mssqllocaldb;AttachDbFilename=D:\Source\Repos\SummerBatchNetCore\Summer.Batch.CoreTests\TestDB.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        private INDbUnitTest  _unitTest;
