...
namespace Summer.Batch.CoreTests.Core.Repository.Dao
{
    ...
    public class DbJobExecutionDaoTest : DaoTestHelper
    {
        ...
        public void TestFindJobExecutions()
        {
            ...
            Assert.IsTrue(createTimes.Contains(new DateTime(2015, 5, 19, 18, 2, 0, DateTimeKind.Utc)));
            Assert.IsTrue(createTimes.Contains(new DateTime(2015, 5, 20, 9, 31, 0, DateTimeKind.Utc)));
        }
