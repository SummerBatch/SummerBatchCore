    ...
    public class UnityTests
    {
        ...
        private class MyDbUnityLoader : UnityLoader
        {
            protected override void LoadConfiguration(IUnityContainer unityContainer)
            {
                ...
                Configuration configuration = ConfigurationManager.OpenExeConfiguration(@"Summer.Batch.CoreTests.dll");
                var customConnection = ConfigurationManager.ConnectionStrings["connection"];
                unityContainer.RegisterInstance(customConnection);
