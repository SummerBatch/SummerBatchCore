...
namespace Summer.Batch.CoreTests.Sort
{
    ...
    public class SorterTest
    {
        ...
        private static readonly Encoding Cp1147 = CodePagesEncodingProvider.Instance.GetEncoding("IBM01147");
        private static readonly Encoding Cp1047 = CodePagesEncodingProvider.Instance.GetEncoding("IBM01047");
        private static readonly Encoding Cp1252 = CodePagesEncodingProvider.Instance.GetEncoding("Windows-1252");
