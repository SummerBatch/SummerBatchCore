...
namespace Summer.Batch.CoreTests.Batch.Tasklets
{
    ...
    public class SqlScriptTaskletTests
    {
        ...
        private const string ConnectionString 
            = @"Data Source=(LocalDB)\mssqllocaldb;AttachDbFilename=D:\Source\Repos\SummerBatchNetCore\Summer.Batch.CoreTests\NewTestDB.mdf;Integrated Security=True;Connect Timeout=30";
