...
namespace Summer.Batch.Core.Repository.Dao
{
    ...
    {
        // OGU : Downgrade for netcore as ConcurrentDictionary is not serializable
        private readonly IDictionary<ContextKey, ExecutionContext> _contexts = new Dictionary<ContextKey, ExecutionContext>();
